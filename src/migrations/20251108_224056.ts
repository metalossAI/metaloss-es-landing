...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_hero\` (
  	...
  	\`subtitle\` text,
  	\`description\` text,
  	\`primary_c_t_a_label\` text,
  	\`primary_c_t_a_type\` text DEFAULT 'custom',
  	\`primary_c_t_a_url\` text,
  	\`primary_c_t_a_new_tab\` integer,
  	\`secondary_c_t_a_label\` text,
  	\`secondary_c_t_a_type\` text DEFAULT 'custom',
  	\`secondary_c_t_a_url\` text,
  	\`secondary_c_t_a_new_tab\` integer,
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_cta_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_block_order_idx\` ON \`pages_blocks_cta_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_block_parent_id_idx\` ON \`pages_blocks_cta_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_block_path_idx\` ON \`pages_blocks_cta_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_block_background_image_idx\` ON \`pages_blocks_cta_block\` (\`background_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_waitlist\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_waitlist_order_idx\` ON \`pages_blocks_waitlist\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_waitlist_parent_id_idx\` ON \`pages_blocks_waitlist\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_waitlist_path_idx\` ON \`pages_blocks_waitlist\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_agent_hero_steps\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`desc\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_agent_hero\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_steps_order_idx\` ON \`pages_blocks_agent_hero_steps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_steps_parent_id_idx\` ON \`pages_blocks_agent_hero_steps\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_agent_hero_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_cards_order_idx\` ON \`pages_blocks_agent_hero_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_cards_parent_id_idx\` ON \`pages_blocks_agent_hero_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_cards_image_idx\` ON \`pages_blocks_agent_hero_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_agent_hero\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_order_idx\` ON \`pages_blocks_agent_hero\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_parent_id_idx\` ON \`pages_blocks_agent_hero\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_agent_hero_path_idx\` ON \`pages_blocks_agent_hero\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_post_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_post_block_order_idx\` ON \`pages_blocks_post_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_post_block_parent_id_idx\` ON \`pages_blocks_post_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_post_block_path_idx\` ON \`pages_blocks_post_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_post_block_post_idx\` ON \`pages_blocks_post_block\` (\`post_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_rolling_image_marquee_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`href\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_rolling_image_marquee\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_rolling_image_marquee_images_order_idx\` ON \`pages_blocks_rolling_image_marquee_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_rolling_image_marquee_images_parent_id_idx\` ON \`pages_blocks_rolling_image_marquee_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_rolling_image_marquee_images_image_idx\` ON \`pages_blocks_rolling_image_marquee_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_rolling_image_marquee\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`speed\` numeric DEFAULT 60,
  	\`height\` numeric DEFAULT 80,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_rolling_image_marquee_order_idx\` ON \`pages_blocks_rolling_image_marquee\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_rolling_image_marquee_parent_id_idx\` ON \`pages_blocks_rolling_image_marquee\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_rolling_image_marquee_path_idx\` ON \`pages_blocks_rolling_image_marquee\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_partners_banner_partners\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`logo_id\` integer,
  	...
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_partners_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_partners_banner_partners_order_idx\` ON \`pages_blocks_partners_banner_partners\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partners_banner_partners_parent_id_idx\` ON \`pages_blocks_partners_banner_partners\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partners_banner_partners_logo_idx\` ON \`pages_blocks_partners_banner_partners\` (\`logo_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_partners_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_partners_banner_order_idx\` ON \`pages_blocks_partners_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partners_banner_parent_id_idx\` ON \`pages_blocks_partners_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partners_banner_path_idx\` ON \`pages_blocks_partners_banner\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_card_image_idx\` ON \`pages_blocks_card\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_grid\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`columns\` numeric DEFAULT 3,
  	\`gap\` text DEFAULT '1.5rem',
  	\`class_name\` text,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_grid_order_idx\` ON \`pages_blocks_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_grid_parent_id_idx\` ON \`pages_blocks_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_grid_path_idx\` ON \`pages_blocks_grid\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_bento_grid_block_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  	...
  	\`header_type\` text,
  	\`class_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_bento_grid_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_grid_block_items_order_idx\` ON \`pages_blocks_bento_grid_block_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_grid_block_items_parent_id_idx\` ON \`pages_blocks_bento_grid_block_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_bento_grid_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_grid_block_order_idx\` ON \`pages_blocks_bento_grid_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_grid_block_parent_id_idx\` ON \`pages_blocks_bento_grid_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_grid_block_path_idx\` ON \`pages_blocks_bento_grid_block\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_cta_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_block_order_idx\` ON \`_pages_v_blocks_cta_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_block_parent_id_idx\` ON \`_pages_v_blocks_cta_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_block_path_idx\` ON \`_pages_v_blocks_cta_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_block_background_image_idx\` ON \`_pages_v_blocks_cta_block\` (\`background_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_waitlist\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_waitlist_order_idx\` ON \`_pages_v_blocks_waitlist\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_waitlist_parent_id_idx\` ON \`_pages_v_blocks_waitlist\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_waitlist_path_idx\` ON \`_pages_v_blocks_waitlist\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_agent_hero_steps\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`desc\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_agent_hero\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_steps_order_idx\` ON \`_pages_v_blocks_agent_hero_steps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_steps_parent_id_idx\` ON \`_pages_v_blocks_agent_hero_steps\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_agent_hero_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_cards_order_idx\` ON \`_pages_v_blocks_agent_hero_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_cards_parent_id_idx\` ON \`_pages_v_blocks_agent_hero_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_cards_image_idx\` ON \`_pages_v_blocks_agent_hero_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_agent_hero\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_order_idx\` ON \`_pages_v_blocks_agent_hero\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_parent_id_idx\` ON \`_pages_v_blocks_agent_hero\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_agent_hero_path_idx\` ON \`_pages_v_blocks_agent_hero\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_post_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_post_block_order_idx\` ON \`_pages_v_blocks_post_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_post_block_parent_id_idx\` ON \`_pages_v_blocks_post_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_post_block_path_idx\` ON \`_pages_v_blocks_post_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_post_block_post_idx\` ON \`_pages_v_blocks_post_block\` (\`post_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_rolling_image_marquee_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_rolling_image_marquee\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rolling_image_marquee_images_order_idx\` ON \`_pages_v_blocks_rolling_image_marquee_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rolling_image_marquee_images_parent_id_idx\` ON \`_pages_v_blocks_rolling_image_marquee_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rolling_image_marquee_images_image_idx\` ON \`_pages_v_blocks_rolling_image_marquee_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_rolling_image_marquee\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rolling_image_marquee_order_idx\` ON \`_pages_v_blocks_rolling_image_marquee\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rolling_image_marquee_parent_id_idx\` ON \`_pages_v_blocks_rolling_image_marquee\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rolling_image_marquee_path_idx\` ON \`_pages_v_blocks_rolling_image_marquee\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_partners_banner_partners\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`logo_id\` integer,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`logo_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_partners_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partners_banner_partners_order_idx\` ON \`_pages_v_blocks_partners_banner_partners\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partners_banner_partners_parent_id_idx\` ON \`_pages_v_blocks_partners_banner_partners\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partners_banner_partners_logo_idx\` ON \`_pages_v_blocks_partners_banner_partners\` (\`logo_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_partners_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partners_banner_order_idx\` ON \`_pages_v_blocks_partners_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partners_banner_parent_id_idx\` ON \`_pages_v_blocks_partners_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partners_banner_path_idx\` ON \`_pages_v_blocks_partners_banner\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_card\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_card_order_idx\` ON \`_pages_v_blocks_card\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_card_parent_id_idx\` ON \`_pages_v_blocks_card\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_card_path_idx\` ON \`_pages_v_blocks_card\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_card_image_idx\` ON \`_pages_v_blocks_card\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_grid\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_grid_order_idx\` ON \`_pages_v_blocks_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_grid_parent_id_idx\` ON \`_pages_v_blocks_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_grid_path_idx\` ON \`_pages_v_blocks_grid\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_bento_grid_block_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	...
  	\`class_name\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_bento_grid_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_grid_block_items_order_idx\` ON \`_pages_v_blocks_bento_grid_block_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_grid_block_items_parent_id_idx\` ON \`_pages_v_blocks_bento_grid_block_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_bento_grid_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_grid_block_order_idx\` ON \`_pages_v_blocks_bento_grid_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_grid_block_parent_id_idx\` ON \`_pages_v_blocks_bento_grid_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_grid_block_path_idx\` ON \`_pages_v_blocks_bento_grid_block\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_preferences_rels_posts_id_idx\` ON \`payload_preferences_rels\` (\`posts_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`header_nav_items_navigation_item_dropdown_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`header_nav_items_navigation_item_dropdown_items_order_idx\` ON \`header_nav_items_navigation_item_dropdown_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`header_nav_items_navigation_item_dropdown_items_parent_id_idx\` ON \`header_nav_items_navigation_item_dropdown_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`header_nav_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`navigation_item_type\` text DEFAULT 'link',
  	\`navigation_item_label\` text NOT NULL,
  	\`navigation_item_link_type\` text DEFAULT 'reference',
  	\`navigation_item_link_new_tab\` integer,
  	\`navigation_item_link_url\` text,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_cta_block\`;`)
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_waitlist\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_agent_hero_steps\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_agent_hero_cards\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_agent_hero\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_post_block\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_rolling_image_marquee_images\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_rolling_image_marquee\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_partners_banner_partners\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_partners_banner\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_card\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_grid\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_bento_grid_block_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_bento_grid_block\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_cta_block\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_waitlist\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_agent_hero_steps\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_agent_hero_cards\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_agent_hero\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_post_block\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_rolling_image_marquee_images\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_rolling_image_marquee\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_partners_banner_partners\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_partners_banner\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_card\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_grid\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_bento_grid_block_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_bento_grid_block\`;`)
  ...
  await db.run(sql`DROP TABLE \`header_nav_items_navigation_item_dropdown_items\`;`)
